 ...
 */
	public void menu()
	{
		...
		{
			/**
			 * כאן חובה להשתמש בקסטינג כי המוריש
			 *  לכל הצבים הוא צב פשוט ולצב פשוט אין את התכונות של ציור מרובע ומצולע על 
			 *  כן חובה להשתמש ב קסטינג כן האוביקט מקבל את האפשרות לגישה למתודות של צב חכם 
			 *  
			 */
			/**
			 * השימוש בפולימורפיזם בא לידי ביטוי במספר קריאות
			 * פולימורפיזם הוא יישום של אותה המתודה בדרכים שונות
			 * ניתן לראות שכאשר צב שיכור קורא לפונקציה של ציור מרובע ומצולע
			 * הוא אינו מיישם את זה כמו צב חכם, כי בתוך המתודה של צב חכם 
			 * בציור ריבוע יש קריאה למתודה של לזוז קדימה וצב שיכור 
			 * מיישם את המתודה של המחלקה שלו
			 */
